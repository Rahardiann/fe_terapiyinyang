  ...
  return (
    <div name="aboutus" className="bg-white min-h-screen relative">
      ...
      <div className="flex flex-col items-center justify-center px-4 pb-52 pt-32 -mt-4">
        ...
        >
          <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold text-center text-second mb-8 animate-fadeInUp">
            About us
          </h1>
          ...
          <p className="text-center text-main mb-12 animate-fadeInUp">
          ...
          <div class="flex flex-col md:flex-row md:justify-center md:items-start pb-8">
            ...
            <div class="md:flex md:flex-col md:justify-start md:items-start mt-20  md:mt-8">
              <p class="text-3xl mx-auto text-center  md:text-left md:mx-0 mb-4 md:max-w-none md:w-80 text-second font-bold ">
                Penyehat Tradisional
              </p>
              <p class="text-2xl mx-auto text-center md:text-left md:mx-0 mb-4 md:max-w-none text-main md:w-80 mt-auto">
              ...
              <p class="text-xl  mx-auto text-center md:text-left md:mx-0 mb-4 md:max-w-none text-main md:w-80 mt-auto">
              ...
              <div className="social-links flex justify-center sm:text-center text-second">
